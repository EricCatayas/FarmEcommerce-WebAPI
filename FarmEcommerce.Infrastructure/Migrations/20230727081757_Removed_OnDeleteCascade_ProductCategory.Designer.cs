...
namespace FarmEcommerce.Infrastructure.Migrations
{
    ...
    [Migration("20230727081757_Removed_OnDeleteCascade_ProductCategory")]
    partial class Removed_OnDeleteCascade_ProductCategory
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Ecommerce.Domain.Entities.Image_Upload", b =>
                {
                    ...
                    b.Property<DateTime>("Upload_Date")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 7, 27, 16, 17, 57, 227, DateTimeKind.Local).AddTicks(7594));
